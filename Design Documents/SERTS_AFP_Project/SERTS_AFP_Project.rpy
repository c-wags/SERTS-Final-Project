...
{ IProject 
	...
	- _modifiedTimeWeak = 11.7.2016::15:31:56;
	- _lastID = 5;
...
<frame name=OperationListCompartment>";
		...
		{ IDiagram 
			...
			- _modifiedTimeWeak = 1.2.1990::0:0:0;
			- _lastModifiedTime = "10.18.2016::14:22:12";
			- _graphicChart = { CGIClassChart 
...
<frame name=OperationListCompartment>";
				...
				{ CGIBasicClass 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.0489381 0 0 0.124343 98.3869 95.6655 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=OperationListCompartment>";
	...
	- MSCS = { IRPYRawContainer 
		...
		{ IMSC 
			...
			- _modifiedTimeWeak = 1.2.1990::0:0:0;
			- _lastModifiedTime = "11.4.2016::14:38:36";
			- _graphicChart = { CGIMscChart 
				...
				{ CGIMscColumnCR 
					...
					- m_drawBehavior = 8;
					- m_transform = 0.65625 0 0 0.00876015 433 50 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIMscColumnCR 
					...
					- m_drawBehavior = 8;
					- m_transform = 0.65625 0 0 0.00876015 279 50 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIMscColumnCR 
					...
					- m_drawBehavior = 8;
					- m_transform = 0.65625 0 0 0.00876015 140 50 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIMscMessage 
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 0;
					- m_SourcePort = 47 14840 ;
					- m_TargetPort = 47 14840 ;
					- m_bLeft = 0;
				}
				{ CGIMscMessage 
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 0;
					- m_SourcePort = 47 17922 ;
					- m_TargetPort = 47 17922 ;
					- m_bLeft = 0;
				}
				{ CGIMscMessage 
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 0;
					- m_SourcePort = 47 22374 ;
					- m_TargetPort = 47 22374 ;
					- m_bLeft = 0;
				}
				{ CGIMscMessage 
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 0;
					- m_SourcePort = 47 26141 ;
					- m_TargetPort = 47 26141 ;
					- m_bLeft = 0;
				}
			...
			- m_pICollaboration = { ICollaboration 
				...
				- ClassifierRoles = { IRPYRawContainer 
					...
					{ IClassifierRole 
						...
						- _modifiedTimeWeak = 11.4.2016::14:33:36;
						- m_eRoleType = CLASS;
						- m_pBase = { IHandle 
							- _m2Class = "";
						}
		...
		{ IMSC 
			...
			- _modifiedTimeWeak = 1.2.1990::0:0:0;
			- _lastModifiedTime = "11.7.2016::15:33:20";
			- _graphicChart = { CGIMscChart 
				- vLadderMargin = 20;
				- m_usingActivationBar = 0;
				...
				{ CGIMscColumnCR 
					...
					- m_drawBehavior = 8;
					- m_transform = 1 0 0 0.00876015 46 50 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIMscColumnCR 
					...
					- m_drawBehavior = 8;
					- m_transform = 1.26042 0 0 0.00876015 340 50 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIMscColumnCR 
					...
					- m_drawBehavior = 8;
					- m_transform = 1 0 0 0.00876015 634 50 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIMscMessage 
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 0;
					- m_SourcePort = 48 12671 ;
					- m_TargetPort = 48 12671 ;
					- m_bLeft = 0;
				}
				{ CGIMscMessage 
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 0;
					- m_SourcePort = 48 41780 ;
					- m_TargetPort = 48 41780 ;
					- m_bLeft = 0;
				}
				{ CGIMscMessage 
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 0;
					- m_SourcePort = 48 20433 ;
					- m_TargetPort = 48 20433 ;
					- m_bLeft = 0;
				}
				{ CGIMscMessage 
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 0;
					- m_SourcePort = 48 30707 ;
					- m_TargetPort = 48 30707 ;
					- m_bLeft = 0;
				}
					...
					{ IClassifierRole 
						...
						- Stereotypes = { IRPYRawContainer 
							...
							{ IHandle 
								...
								- _class = "";
								- _name = "human user";
								- _id = GUID b29deb10-159f-4533-b806-6dbd9c353a05;
							}
						}
						- _modifiedTimeWeak = 10.18.2016::14:9:14;
						- m_eRoleType = CLASS;
						- m_pBase = { IHandle 
							- _m2Class = "";
						}
					...
					{ IClassifierRole 
						...
						- Stereotypes = { IRPYRawContainer 
							...
							{ IHandle 
								...
								- _class = "";
								- _name = "user interface";
								- _id = GUID 0ae1787f-a856-4dc5-ac4a-5d5571594222;
							}
						}
						- _modifiedTimeWeak = 10.18.2016::14:23:42;
						- m_eRoleType = CLASS;
						- m_pBase = { IHandle 
							- _m2Class = "";
						}
	...
	- UCDiagrams = { IRPYRawContainer 
		...
		{ IUCDiagram 
			...
			- _modifiedTimeWeak = 1.2.1990::0:0:0;
			- _lastModifiedTime = "10.11.2016::14:38:43";
			- _graphicChart = { CGIClassChart 
				...
				{ CGIBasicClass 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.124004 0 0 0.0961718 383.248 242.096 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
